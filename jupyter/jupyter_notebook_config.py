...
c.NotebookApp.tornado_settings = {
            'headers': {
                        'Content-Security-Policy': "frame-ancestors 'self' http://localhost:8000/ http://localhost:8000/*",
                            }
            } 
...
#  Choices: any of ['blake2b', 'sha512', 'md5', 'blake2s', 'sha384', 'sha3_512', 'sha256', 'sha3_256', 'sha3_224', 'sha224', 'sha3_384', 'sha1']
#  Default: 'sha256'
