...
#  JupyterHub API.
#  Default: {}
#c.JupyterHub.api_tokens = { "948e75e9f62e2a3be544562b33c762c3e727d56b446d21c79277bda3fb5d2901" : "service-admin"}
...
#  Default: '/home/rcooray/anaconda3/envs/jupyterlab-ext/share/jupyterhub'
# c.JupyterHub.data_files_path = '/home/rcooray/anaconda3/envs/jupyterlab-ext/share/jupyterhub'
...
c.JupyterHub.load_roles = [
{
  ...
  'scopes': ['read:hub', 'admin:users', 'tokens', 'read:tokens', 'list:users', 'read:servers', 'servers', 'proxy', 'access:servers', 'list:services' ],
...
#  managed services.
#  Default: {}
#c.JupyterHub.service_tokens = {'948e75e9f62e2a3be544562b33c762c3e727d56b446d21c79277bda3fb5d2901' : 'service-admin'}
...
c.JupyterHub.services = [
    {
        "name" : "service-admin",
        "api_token" : "948e75e9f62e2a3be544562b33c762c3e727d56b446d21c79277bda3fb5d2901"
    },
   #{
   #    'name' : 'rest/foo',
   #    'url' : 'http://localhost:8888',
   #    'api_token' : "948e75e9f62e2a3be544562b33c762c3e727d56b446d21c79277bda3fb5d2901",
   #    'command' : ['jupyter', 'kernelgateway', '--KernelGatewayApp.api=kernel_gateway.notebook_http', '--KernelGatewayApp.seed_uri=/home/rcooray/coorayTest1.ipynb']
   #}
]
...
#c.Spawner.cmd = ['jupyter-nbconvert --to HTML /home/rcooray/coorayTest.ipynb']
...
#  Default: set()
c.Authenticator.admin_users = set('service-admin')
